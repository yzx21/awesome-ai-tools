...
- [Ctrome](https://ctrome.ai/) - Mac-native AI companion with a selection toolbar and floating bar (⌃⌃) for instant ChatGPT, rewrite, translate, OCR, and local memory recall. 
